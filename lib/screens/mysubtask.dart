...
class RemainingSubTask extends StatelessWidget {
  const RemainingSubTask({Key key}) : super(key: key);
  static const id = "subtask";
  @override
  Widget build(BuildContext context) {
    final String args = ModalRoute.of(context).settings.arguments;
    return RemainingSubTaskToComplete(getID: args);
  }
}

class RemainingSubTaskToComplete extends StatefulWidget {
  RemainingSubTaskToComplete({this.getID});
  final String getID;
  @override
  _RemainingSubTaskToCompleteState createState() =>
      _RemainingSubTaskToCompleteState(taskId: getID);
}

class _RemainingSubTaskToCompleteState
    extends State<RemainingSubTaskToComplete> {
  _RemainingSubTaskToCompleteState({this.taskId});
  String taskId;
  String barTitle;
  ...
  Future<void> getTaskData() async {
    ...
    String webUrl = "https://clockk.in/api/my_check_list/$taskId";
        ...
        buttons: [
          DialogButton(
            ...
            onPressed: () async {
              ...
              String webUrl =
                  "https://clockk.in/api/my_check_list_complete?task_id=$completedIds&comment=${comment == '' ? 'No Comment' : comment}&title_id=$taskId";
              var url = Uri.parse(webUrl);
