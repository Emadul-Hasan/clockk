...
import 'mysubtask.dart';
import 'notification.dart';

class MyRemainingTaskTitle extends StatefulWidget {
  static const id = "MyCheckListTitle";

  @override
  _MyRemainingTaskTitleState createState() => _MyRemainingTaskTitleState();
}

class _MyRemainingTaskTitleState extends State<MyRemainingTaskTitle> {
  ...
  Future<void> getTaskData() async {
    ...
    String webUrl = "https://clockk.in/api/getMyChecklist";
