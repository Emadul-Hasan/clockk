...
class StuffInMyTaskTiles extends StatefulWidget {
  final MyTile myTile;

  bool currentState;
  StuffInMyTaskTiles(this.myTile, this.currentState);

  @override
  _StuffInMyTaskTilesState createState() => _StuffInMyTaskTilesState();
}

class _StuffInMyTaskTilesState extends State<StuffInMyTaskTiles> {
  @override
